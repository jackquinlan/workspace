        ...
        <div className="flex items-center justify-between space-x-4">
          <div className="space-y-0">
            ...
            <h2 className="text-xs leading-5 [&:not(:first-child)]:mt-6">
              Share this secret link to invite people to your workspace. You can disable this
              feature or{" "}
              <ResetLinkModal updateLink={(next: string) => setInviteLink(next)} form={form} />.
            </h2>
          </div>
          <FormField
            ...
            render={({ field }) => (
              <FormControl>
                <Switch type="submit" checked={field.value} onCheckedChange={field.onChange} />
              </FormControl>
            )}
          />
        </div>
  ...
  return (
    <AlertDialog>
      ...
      <AlertDialogContent className="top-[30%] w-[20%]">
        ...
        <AlertDialogDescription>
          Are you sure you want to reset your invitation link? Your old link will no longer be able
          to be used.
        </AlertDialogDescription>
        <AlertDialogFooter>
