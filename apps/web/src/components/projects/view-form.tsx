      ...
      <FormField
        ...
        render={({ field }) => (
          <FormItem>
            ...
            <FormControl>
              <Input autoComplete="off" className="h-8" placeholder="View name" {...field} />
            </FormControl>
            <FormMessage />
          </FormItem>
        )}
        ...
        <FormItem key={view.label}>
          <FormControl>
            <div>
              ...
              <Label
                htmlFor={view.type}
                className="border-muted bg-popover hover:bg-accent peer-data-[state=checked]:border-primary flex flex-col items-center justify-between space-y-3 rounded-md border-2 p-3 text-zinc-500 peer-data-[state=checked]:text-black"
              >
